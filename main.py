...
async def on_message(message: discord.Message) -> None:
    ...
    # Extract social media & YouTube links
    ...
    for video_id in youtube_links:
        new_url = f"http://inv.nadeko.net/watch?v={video_id}"
        logger.info(f'{message.guild.name}: {message.author} shared a YouTube link, replaced with {new_url}')

        new_message = f'{message.author.mention} {PREAMBLE}{message.content.replace("youtube.com/watch?v=" + video_id, new_url)}'
